...
## Recent Changes
- 2026-03-07: Visual polish pass for town world - varied tree types (pine with layered canopy + round leafy trees with clustered foliage, color variation), multi-sphere bushes, clustered rocks, colorful flower patches (18 clusters with varied colors), 9 street lamps with warm point lights along roads, improved roads with sidewalks and dashed lane markings, wooden fence around house yard with walk-through gap, animated drifting clouds in sky, warmer golden-hour lighting with fill light
