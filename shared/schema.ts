...
export const progressDataSchema = z.object({
  ...
  factoryPracticeUnlocked: z.boolean(),
  ...
  psychicCustomersServed: z.number(),
  psychicGamePhase: z.string(),
